...
// Package cmd implementes the root command and sub commands for gool. This
// is done with the help of a fork of package cobra
// (https://github.com/spf13/cobra). The only reason for forking cobra instead
// of using the original package was to have a German translation of the help
// texts.
